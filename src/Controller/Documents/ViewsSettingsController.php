...
#[Route(path: "dashboard/document/configuration", name: "document_configuration_settings_controller")]
class ViewsSettingsController extends AbstractController
{
    ...
    #[Route(path: "/{type}", name: "document_configuration", methods: ["GET"])]
    public function manage(Request $request, string $type): Response
    {
        $roleMap = [
            'mprogram' => ['01', '02', '03', '04'],
            'mcourse' => ['01'],
            'munit' => ['01'],
            'muser' => ['01'],
            'mresource' => ['01'],
